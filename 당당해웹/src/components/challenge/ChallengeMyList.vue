<template>
  <div>
    <!-- 챌린지 이름을 누르면 MyChallenge.vue로 이동합니다. -->
    <!-- 나의 챌린지 목록 시작 -->
    <!--https://codepen.io/zavoloklom/pen/yLmZeQ-->
    <div class="spacing-container"></div>
    <router-link to="/mypage/challenge">
      <div class="title-text">MY Challenge</div>
    </router-link>
    ...
    <div id="demo">
      ...
      >
        ...
        <table id="table" class="table table-hover table-mc-light-blue">
          <thead>
            <tr style="border-radius: 20px 20px 0px 0px">
              <th style="font-weight: 500">NO</th>

              <th style="font-weight: 600">챌린지</th>

              <th style="font-weight: 600">기간</th>
              <th style="font-weight: 600">진행상태</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(list, index) in myChallenge" :key="index">
              <td data-title="ID">{{ index + 1 }}</td>
              <td data-title="Name">
                <!-- 필수 -->
                <!-- /challenge/detail/:id -->
                <router-link :to="`/challenge/detail/${list.no}`">{{
                  list.title
                }}</router-link>
                <!-- <th style="font-weight: 600" @click="movePage">챌린지</th> -->
              </td>
              <td data-title="Link">
    ...
    <!--나의 챌린지 목록 끝-->
    <!-- 자세히보기를 누르면 ChallengeBoardDetail.vue로 이동합니다. -->
  </div>
</template>
