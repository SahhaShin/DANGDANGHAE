<template>
  <div>
    ...
    <!-- 현재 나의 랭킹을 보여줍니다. -->
    <!-- 전체 랭킹 리스트를 보여줍니다. -->
    <!--https://codepen.io/Russwfranklin/pen/gGodXO-->

    <body class="page-leaderboard" style="margin-top: 5%">
      <div id="contain-all" class="slideout-panel">
        ...
        <section class="leaderboard-progress">
          <div class="contain text-center">
            ...
            />
            <h2 style="font-weight: bold">MY RANKING</h2>
            <h2 style="font-weight: bold; color: #ecc81a">{{ myrank }}위</h2>
          </div>
        </section>
          ...
          <div class="contain">
            <div class="ranking-table">
              <div class="ranking-table-header-row">
                ...
                <div class="ranking-table-header-data h6">Point</div>
              </div>
              <!--1~3등 리스트 시작-->
              <div class="ranking-table-row-leader-1">
                ...
                <div class="ranking-table-data">{{ users[0].nick_name }}</div>
              ...
              <div class="ranking-table-row-leader-2">
                ...
                <div class="ranking-table-data">{{ users[1].nick_name }}</div>
                <div class="ranking-table-data">
                  {{ users[1].point }}
                </div>
              </div>
              <div class="ranking-table-row-leader-3">
                ...
                <div class="ranking-table-data">{{ users[2].nick_name }}</div>
                <div class="ranking-table-data">
                  {{ users[2].point }}
                </div>
              </div>
              ...
              <div class="ranking-table-body">
                <!--4~99위 v-for 시작-->
                <div
                  v-for="(user, index) in afterthird"
                  :key="index"
                  class="ranking-table-row"
                >
                  <div class="ranking-table-data">{{ index + 4 }}</div>
                  <div class="ranking-table-data">{{ user.nick_name }}</div>
                  <div class="ranking-table-data">
                    {{ user.point }}
                  </div>
                </div>
...
<script scoped>
import RankingHeader from "../components/common/RankingHeader.vue";
import MainFooter from "../components/common/MainFooter.vue";
import { mapGetters } from "vuex";
export default {
  components: { RankingHeader, MainFooter },
  name: "Ranking",
  created() {
