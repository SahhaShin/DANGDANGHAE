<template>
  <div>
    <div>
      <div class="main-body-self">
        <!-- 내가 참여한 챌린지들을 볼 수 있습니다 -->
        <div style="width: 100%; height: 5rem" />
        <div class="self-text-banner" style="margin-bottom: -2em">
          다 함께 도전할까요?
        </div>
        <challenge-my-list />
        <!-- 현재 인기 챌린지들이 보입니다. -->
        ...
        <body>
          <div class="wrapper">
            <ul id="timeline">
              ...
              <router-link to="/challenge/write"
                ><li class="date make">챌린지 만들기</li></router-link
              >
        ...
        <body>
          <div class="wrapper">
            <ul id="timeline">
              <!-- 한칸 시작 -->
              <li class="date">전체 챌린지</li>

              <li
                v-for="(card, index) in challenges"
                :key="index"
                @click="movePage_detail(card.no)"
                class="listing clearfix"
              >
